...
import { HomeRounded, LabelRounded, MusicNoteRounded } from '@mui/icons-material';
...
export const Musica = () => {
  ...
  //   const proyectosGastronomia = docList.docs.filter((doc) => doc.data().tematica === 'Musica');
  ...
  return (
    <Box sx={{bgcolor: "background.default"}}>
      {/* Breadcrumbs */}
      <Bread migas={[{miga: "INICIO", ruta: "/inicio", icono: <HomeRounded/>},{miga: "TEMATICAS", ruta: "/tematicas", icono: <LabelRounded/>},{miga: "MÚSICA", ruta: "/tematicas/musica", icono: <MusicNoteRounded/>}]}/>
        ...
        <Grid container spacing={1}> {/* G R I D  G R A L. */}
          {
            loading ? (
              ...
              data
                .filter(proyecto => proyecto.tematica === 'Musica')
                .map(proyecto => {
                return (
