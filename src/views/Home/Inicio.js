    ...
    <WrapperSingleRoute>
      <Box sx={{ textAlign: "center", padding: "15px 0"}}>
        <Box sx={{bgcolor: 'primary.main', borderRadius: "50px", display: "inline-flex"}}>
          ...
          <Box sx={{padding: "7px 14px", borderRadius: "50px"}}>  
            <Typography component={Link} to="/mapa" sx={{textDecoration: "none", color: "background.default", '&:hover':{color: "background.default"}}}>
              Mapa <MapIcon/>
            </Typography>
          </Box>
        </Box>
      ...
      <Grid container >
        <Grid item md={6} xs={12}>
          <Paper sx={{p:{xs:2, sm:3, md:5}, m:{xs:1, sm:3, md: 5}, bgcolor: "background.paper"}} elevation={1} >
