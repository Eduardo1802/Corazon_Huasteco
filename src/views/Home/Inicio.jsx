          ...
          {/* SECTION THREE -- COLABORADORES */}
            <Grid container columnSpacing={2} py={5} my={5} >
              ...
              <Grid item container xs={12} sm={6} md={8} direction="column" justifyContent="center">
                ...
                <Button variant='outlined' component={Link} to="/creadores-de-contenido" endIcon={<ArrowForward/>} sx={{borderRadius: 5, '&:hover':{backgroundColor: theme.palette.primary.main, color: theme.palette.background.paper}}}>
                  Explora sus Voces
                </Button>
              </Grid>
            </Grid>
          ...
          {/* SECTION FOUR -- FLORA */}
            <Grid container columnSpacing={2} rowSpacing={2} py={5} my={5}>
              <Grid item container xs={12} sm={6} md={5} direction="column" justifyContent="center" order={{xs: 2, sm:1}}>
                ...
                <Button variant='outlined' component={Link} to="/tematicas" endIcon={<LocalFlorist/>} sx={{borderRadius: 5, '&:hover':{backgroundColor: theme.palette.primary.main, color: theme.palette.background.paper}}}>
                  Ver más
                </Button>
              </Grid>
          ...
          {/* SECTION FIVE -- FAUNA */}
            <Grid container columnSpacing={2} rowSpacing={2} py={5} my={5}>
              ...
              <Grid item container xs={12} sm={6} md={5} direction="column" justifyContent="center" order={{xs: 2, sm:2}}>
                ...
                <Button variant='outlined' component={Link} to="/tematicas" endIcon={<Pets/>} sx={{borderRadius: 5, '&:hover':{backgroundColor: theme.palette.primary.main, color: theme.palette.background.paper}}}>
                  Ver más
                </Button>
              </Grid>
            </Grid>
          ...
          {/* SECTION SIX -- COLINDANCIAS */}
            <Grid container columnSpacing={2} rowSpacing={2} py={5} mt={5}>
              <Grid item container xs={12} sm={12} md={4} direction="column" justifyContent="center" order={{xs: 1, sm:1}}>
                ...
                <Button variant='outlined' component={Link} to="/mapa" endIcon={<Directions/>} sx={{borderRadius: 5, '&:hover':{backgroundColor: theme.palette.primary.main, color: theme.palette.background.paper}}}>
                  Ver mapa
                </Button>
              </Grid>
